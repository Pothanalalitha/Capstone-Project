...
public class MedicalRecordDTO {
    ...
    public MedicalRecordDTO(String id, Long patientId, String description, String issue, String doctorName,
                            LocalDateTime treatedAt, LocalDate revisitDate, List<MedicineDTO> medicines) {
        this.id = id;
    ...
    public LocalDateTime getTreatedAt() { return treatedAt; }
    public void setTreatedAt(LocalDateTime treatedAt) { this.treatedAt = treatedAt; }
