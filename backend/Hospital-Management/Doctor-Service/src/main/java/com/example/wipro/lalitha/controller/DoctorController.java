...
public class DoctorController {
    ...
    public ResponseEntity<DoctorDTO> createDoctor(@RequestParam String userId,@Valid @RequestBody DoctorDTO dto) {
    	 AuditLogDTO auditLogDTO = new AuditLogDTO(userId,"CREATE","DOCTOR","Created Doctor");
    ...
    public ResponseEntity<DoctorDTO> updateDoctor(@RequestParam String userId,@PathVariable Long id, @Valid @RequestBody DoctorDTO dto) {
    	 AuditLogDTO auditLogDTO = new AuditLogDTO(userId,"UPDATE","DOCTOR","Updated Doctor");
         auditServiceClient.saveAuditLog(auditLogDTO);
        return ResponseEntity.ok(doctorService.updateDoctor(id, dto));
    }

    @DeleteMapping("/DeleteDoctorById/{id}")
    public ResponseEntity<String> deleteDoctor(@RequestParam String userId,@PathVariable Long id) {
    	AuditLogDTO auditLogDTO = new AuditLogDTO(userId,"DELETE","DOCTOR","Delete Doctor");
        auditServiceClient.saveAuditLog(auditLogDTO);
